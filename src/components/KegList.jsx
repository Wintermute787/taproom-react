...
const masterKeg = [
    ...
    },
    {
        ...
        brand: "Coniston",
        alc: "5.8%",
        description: "his Pilsner Style top fermented Lager uses 100% Hallertau Hersbrucker leaf hops from Southern Germany, Pale malt and wheat to give an authentic crisp, clean, Continental style beer. The beer is matured for over 30 days and is available in bottle, cask and keg. Thurstein was the name given to Coniston Water by Norse settlers in the Dark Ages.",
        image: "Coniston1"
    },
    {
